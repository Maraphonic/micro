...
@RestController
@RequestMapping("/api/micro-kafka")
public class MicroKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MicroKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroKafkaResource(KafkaProperties kafkaProperties) {
